...
public class ModBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup arg) {
        ...
        getOrCreateTagBuilder(BlockTags.PICKAXE_MINEABLE)
                ...
                .add(ModBlocks.SINGLE_CONDENSED_PEARLESCENT_FROGLIGHT)
                ...
                .add(ModBlocks.SINGLE_CONDENSED_CRYING_OBSIDIAN)
                .add(ModBlocks.SINGLE_CONDENSED_COPPER_BULB)
                .add(ModBlocks.SINGLE_CONDENSED_SHROOMLIGHT)
                .add(ModBlocks.SINGLE_CONDENSED_DIAMOND_BLOCK)
                ...
                .add(ModBlocks.DOUBLE_CONDENSED_PEARLESCENT_FROGLIGHT)
                ...
                .add(ModBlocks.DOUBLE_CONDENSED_CRYING_OBSIDIAN)
                .add(ModBlocks.DOUBLE_CONDENSED_COPPER_BULB)
                .add(ModBlocks.DOUBLE_CONDENSED_SHROOMLIGHT)
                .add(ModBlocks.DOUBLE_CONDENSED_DIAMOND_BLOCK)
                ...
                .add(ModBlocks.TRIPLE_CONDENSED_PEARLESCENT_FROGLIGHT)
                .add(ModBlocks.TRIPLE_CONDENSED_COPPER_BULB)
                ...
                .add(ModBlocks.TRIPLE_CONDENSED_DIAMOND_BLOCK)
                ...
                .add(ModBlocks.QUADRUPLE_CONDENSED_PEARLESCENT_FROGLIGHT)
                .add(ModBlocks.QUADRUPLE_CONDENSED_COPPER_BULB)
