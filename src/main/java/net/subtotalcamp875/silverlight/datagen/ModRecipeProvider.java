        ...
        if (isBlackhole) {
            if (isMainBlackholeItems) {
                ...
                ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORE_OF_LIGHT, 1)
                        ...
                        .pattern("GNE")
                        .pattern("LFS")
                        .input('R', ModBlocks.DOUBLE_CONDENSED_RESPAWN_ANCHOR)
                        .input('T', ModBlocks.QUADRUPLE_CONDENSED_TORCH)
                        .input('C', ModBlocks.DOUBLE_CONDENSED_COPPER_BULB)
                        .input('G', ModBlocks.QUADRUPLE_CONDENSED_GLOWSTONE)
                        .input('N', Items.NETHER_STAR)
                        .input('E', ModBlocks.QUADRUPLE_CONDENSED_END_ROD)
                        .input('L', ModBlocks.DOUBLE_CONDENSED_LANTERN)
                        .input('F', ModBlocks.QUADRUPLE_CONDENSED_FURNACE)
                ...
                ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.MULTI_PISTON, 1)
                        ...
                        .input('P', ModBlocks.QUADRUPLE_CONDENSED_PISTON)
            ...
            if (isCondensedItem) {
                ...
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, ModItems.DOUBLE_CONDENSED_DRAGON_HEAD, RecipeCategory.MISC, ModItems.TRIPLE_CONDENSED_EXPERIENCE_BOTTLE, "_from_triple_condensed_experience_bottle", "triple_condensed_experience_bottle");
            ...
            if (isCondensedBlocks) {
                ...
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, Items.TORCH, RecipeCategory.MISC,  ModBlocks.SINGLE_CONDENSED_TORCH, "_from_single_condensed_torch", "single_condensed_torch");
                ...
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, Items.END_ROD, RecipeCategory.MISC,  ModBlocks.SINGLE_CONDENSED_END_ROD, "_from_single_condensed_end_rod", "single_condensed_end_rod");
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, Items.FURNACE, RecipeCategory.MISC,  ModBlocks.SINGLE_CONDENSED_FURNACE, "_from_single_condensed_furnace", "single_condensed_furnace");
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, Items.PISTON, RecipeCategory.MISC,  ModBlocks.SINGLE_CONDENSED_PISTON, "_from_single_condensed_piston", "single_condensed_piston");
                ...
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, Items.SLIME_BALL, RecipeCategory.MISC,  ModBlocks.SINGLE_CONDENSED_SLIME_BLOCK, "_from_single_condensed_slime_block", "single_condensed_slime_block");
                ...
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, Items.LANTERN, RecipeCategory.MISC,  ModBlocks.SINGLE_CONDENSED_LANTERN, "_from_single_condensed_lantern", "single_condensed_lantern");
                ...
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, Items.RESPAWN_ANCHOR, RecipeCategory.MISC,  ModBlocks.SINGLE_CONDENSED_RESPAWN_ANCHOR, "_from_single_condensed_respawn_anchor", "single_condensed_respawn_anchor");
                ...
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, ModBlocks.SINGLE_CONDENSED_TORCH, RecipeCategory.MISC,  ModBlocks.DOUBLE_CONDENSED_TORCH, "_from_double_condensed_torch", "double_condensed_torch");
                ...
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, ModBlocks.SINGLE_CONDENSED_END_ROD, RecipeCategory.MISC,  ModBlocks.DOUBLE_CONDENSED_END_ROD, "_from_double_condensed_end_rod", "double_condensed_end_rod");
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, ModBlocks.SINGLE_CONDENSED_FURNACE, RecipeCategory.MISC,  ModBlocks.DOUBLE_CONDENSED_FURNACE, "_from_double_condensed_furnace", "double_condensed_furnace");
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, ModBlocks.SINGLE_CONDENSED_PISTON, RecipeCategory.MISC,  ModBlocks.DOUBLE_CONDENSED_PISTON, "_from_double_condensed_piston", "double_condensed_piston");
                ...
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, ModBlocks.SINGLE_CONDENSED_LANTERN, RecipeCategory.MISC,  ModBlocks.DOUBLE_CONDENSED_LANTERN, "_from_double_condensed_lantern", "double_condensed_lantern");
                ...
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, ModBlocks.SINGLE_CONDENSED_RESPAWN_ANCHOR, RecipeCategory.MISC,  ModBlocks.DOUBLE_CONDENSED_RESPAWN_ANCHOR, "_from_double_condensed_respawn_anchor", "double_condensed_respawn_anchor");
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, ModBlocks.SINGLE_CONDENSED_COPPER_BULB, RecipeCategory.MISC,  ModBlocks.DOUBLE_CONDENSED_COPPER_BULB, "_from_double_condensed_copper_bulb", "double_condensed_copper_bulb");
                ...
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, ModBlocks.DOUBLE_CONDENSED_TORCH, RecipeCategory.MISC,  ModBlocks.TRIPLE_CONDENSED_TORCH, "_from_triple_condensed_torch", "triple_condensed_torch");
                ...
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, ModBlocks.DOUBLE_CONDENSED_END_ROD, RecipeCategory.MISC,  ModBlocks.TRIPLE_CONDENSED_END_ROD, "_from_triple_condensed_end_rod", "triple_condensed_end_rod");
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, ModBlocks.DOUBLE_CONDENSED_FURNACE, RecipeCategory.MISC,  ModBlocks.TRIPLE_CONDENSED_FURNACE, "_from_triple_condensed_furnace", "triple_condensed_furnace");
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, ModBlocks.DOUBLE_CONDENSED_PISTON, RecipeCategory.MISC,  ModBlocks.TRIPLE_CONDENSED_PISTON, "_from_triple_condensed_piston", "triple_condensed_piston");
                ...
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, ModBlocks.TRIPLE_CONDENSED_TORCH, RecipeCategory.MISC,  ModBlocks.QUADRUPLE_CONDENSED_TORCH, "_from_quadruple_condensed_torch", "quadruple_condensed_torch");
                ...
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, ModBlocks.TRIPLE_CONDENSED_END_ROD, RecipeCategory.MISC,  ModBlocks.QUADRUPLE_CONDENSED_END_ROD, "_from_quadruple_condensed_end_rod", "quadruple_condensed_end_rod");
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, ModBlocks.TRIPLE_CONDENSED_FURNACE, RecipeCategory.MISC,  ModBlocks.QUADRUPLE_CONDENSED_FURNACE, "_from_quadruple_condensed_furnace", "quadruple_condensed_furnace");
                offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, ModBlocks.TRIPLE_CONDENSED_PISTON, RecipeCategory.MISC,  ModBlocks.QUADRUPLE_CONDENSED_PISTON, "_from_quadruple_condensed_piston", "quadruple_condensed_piston");
