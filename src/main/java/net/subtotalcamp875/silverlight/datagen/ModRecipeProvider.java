...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter exporter) {
        ...
        /**
         ...
         offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, ModItems.SINGLE_CONDENSED_LANTERN, RecipeCategory.MISC,  ModBlocks.DOUBLE_CONDENSED_LANTERN, "_from_double_condensed_lantern", "double_condensed_lantern");

         offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, ModItems.DOUBLE_CONDENSED_DRAGON_HEAD, RecipeCategory.MISC, ModItems.TRIPLE_CONDENSED_DRAGON_HEAD, "_from_triple_condensed_experience_bottle", "triple_condensed_experience_bottle");
