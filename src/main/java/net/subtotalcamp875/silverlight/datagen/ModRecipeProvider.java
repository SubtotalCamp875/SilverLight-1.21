...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter exporter) {
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.BACKPACK, 1)
                ...
                .offerTo(exporter, net.minecraft.util.Identifier.of(getRecipeName(ModItems.BACKPACK)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.STRETCHY_LEATHER, 1)
                ...
                .criterion(hasItem(Items.LEATHER), conditionsFromItem(Items.LEATHER))
                .offerTo(exporter, net.minecraft.util.Identifier.of(getRecipeName(ModItems.STRETCHY_LEATHER)));
    }
}